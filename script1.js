...
//         function CB(student,index)
//         {
//            var {age}=student
//             if(name[0]=='A' || name[0]=='B' || name[0]=='C' || name[0]=='D')
//                 {
//                     select_student.push(student);
//                 }
//           }

//         classroom.forEach(CB);
//         console.log(select_student.length);



// *******using filters *******
        // var select_students = classroom.filter((student,index)=>{
        //     var {age}=student
        //     return age >=21;
        // });
        ...
        // console.log(select_students.length);
        // for (var i = 0; i<select_students.length; i++)
        // {
        //     console.log(select_students[i].name);
        // }
        ...
        for (var i = 0; i<classroom.length; i++)
                {
                    if(classroom[i].name[0] =='A' || classroom[i].name[0]=='B' || classroom[i].name[0]=='C' || classroom[i].name[0]=='D')
                        arr.push(classroom[i].name);
                }
